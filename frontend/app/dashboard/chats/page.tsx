      ...
      <div className="flex">
        ...
        <section className="flex-1 p-8">
          <div className="rounded-lg border border-stone-200 bg-white p-6">
            <h2 className="text-3xl font-bold text-stone-900">💬 Chats</h2>
            <p className="mt-2 text-stone-600">
              Manage and view all your support conversations
            </p>
          </div>

          <div className="mt-8 rounded-lg border border-stone-200 bg-white p-6">
            <p className="text-stone-600">No chats available yet. Start a new conversation to get started.</p>
          </div>
        </section>
      </div>
    </main>
